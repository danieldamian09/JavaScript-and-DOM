const itemsName = document.getElementsByTagName('li')
// console.log(itemsName)

for (let i = 0; i < itemsName.length; i++) {
  if(i % 2 == 0){
    let element = itemsName[i];
    element.style.background = "#f2f2f2"
  }
  
}

// Podemos hacer uso de muchos atributos para modificar el estilo de un elemento, ejemplo
